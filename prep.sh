...
curl "https://raw.githubusercontent.com/mrcmn/workshop-control-repo/production/workshop_key.enc" -L -o ~/workshop_key.enc
...
git remote add origin git@github.com:mrcmn/workshop-control-repo
